###############################################################################
# Onboarding Backend - Container App & APIM (UAT PNPG)
###############################################################################
...
locals {
  ...
  private_dns_name_onboarding_backend = "selc-u-pnpg-onboardingbackend-ca.orangeground-0bd2d4dc.westeurope.azurecontainerapps.io"
  ...
  dns_zone_prefix_onboarding_backend = "imprese.uat.notifichedigitali"
  api_dns_zone_prefix_onboarding_backend = "api-pnpg.uat.selfcare"
}
