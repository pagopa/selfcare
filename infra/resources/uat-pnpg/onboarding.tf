...
locals {
  onboarding_functions = {
    ...
    app_settings = [
      { name = "APPLICATIONINSIGHTS_CONNECTION_STRING", value = "@Microsoft.KeyVault(SecretUri=https://selc-u-pnpg-kv.vault.azure.net/secrets/appinsights-connection-string/)" },
      { name = "USER_REGISTRY_URL", value = "https://api.uat.pdv.pagopa.it/user-registry/v1" },
      { name = "MONGODB_CONNECTION_URI", value = "@Microsoft.KeyVault(SecretUri=https://selc-u-pnpg-kv.vault.azure.net/secrets/mongodb-connection-string/)" },
      { name = "USER_REGISTRY_API_KEY", value = "@Microsoft.KeyVault(SecretUri=https://selc-u-pnpg-kv.vault.azure.net/secrets/user-registry-api-key/)" },
      { name = "BLOB_STORAGE_CONN_STRING_PRODUCT", value = "@Microsoft.KeyVault(SecretUri=https://selc-u-pnpg-kv.vault.azure.net/secrets/blob-storage-product-connection-string/)" },
      { name = "STORAGE_CONTAINER_CONTRACT", value = "sc-u-documents-blob" },
      { name = "STORAGE_CONTAINER_PRODUCT", value = "selc-u-product" },
      { name = "BLOB_STORAGE_CONN_STRING_CONTRACT", value = "@Microsoft.KeyVault(SecretUri=https://selc-u-pnpg-kv.vault.azure.net/secrets/contracts-storage-connection-string/)" },
      ...
      { name = "MAIL_SENDER_ADDRESS", value = "@Microsoft.KeyVault(SecretUri=https://selc-u-pnpg-kv.vault.azure.net/secrets/smtp-usr/)" },
      { name = "MAIL_SERVER_USERNAME", value = "@Microsoft.KeyVault(SecretUri=https://selc-u-pnpg-kv.vault.azure.net/secrets/smtp-usr/)" },
      { name = "MAIL_SERVER_PASSWORD", value = "@Microsoft.KeyVault(SecretUri=https://selc-u-pnpg-kv.vault.azure.net/secrets/smtp-psw/)" },
      ...
      { name = "ADDRESS_EMAIL_NOTIFICATION_ADMIN", value = "@Microsoft.KeyVault(SecretUri=https://selc-u-pnpg-kv.vault.azure.net/secrets/portal-admin-operator-email/)" },
      ...
      { name = "MS_USER_URL", value = "https://selc-u-pnpg-user-ms-ca.victoriousfield-e39534b8.westeurope.azurecontainerapps.io" },
      { name = "MS_CORE_URL", value = "https://selc-u-pnpg-ms-core-ca.blackhill-644148c0.westeurope.azurecontainerapps.io" },
      { name = "JWT_BEARER_TOKEN", value = "@Microsoft.KeyVault(SecretUri=https://selc-u-pnpg-kv.vault.azure.net/secrets/jwt-bearer-token-functions/)" },
      { name = "MS_PARTY_REGISTRY_URL", value = "https://selc-u-pnpg-party-reg-proxy-ca.victoriousfield-e39534b8.westeurope.azurecontainerapps.io" },
      ...
      { name = "EVENT_HUB_BASE_PATH", value = "https://selc-u-eventhub-ns.servicebus.windows.net" },
      ...
      { name = "JWT_TOKEN_PRIVATE_KEY", value = "@Microsoft.KeyVault(SecretUri=https://selc-u-pnpg-kv.vault.azure.net/secrets/jwt-private-key/)" },
      { name = "JWT_TOKEN_KID", value = "@Microsoft.KeyVault(SecretUri=https://selc-u-pnpg-kv.vault.azure.net/secrets/jwt-kid/)" }
    ]
  }
}
