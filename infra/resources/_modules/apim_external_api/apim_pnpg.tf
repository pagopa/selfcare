module "apim_pnpg" {
  ...
  policy_xml = file("${path.module}/api_pnpg/base_policy.xml")
}
...
module "apim_pnpg_external_api_data_vault_v1" {
  source              = "git::https://github.com/pagopa/terraform-azurerm-v4.git//api_management_api?ref=v10.9.0"
  ...
  content_value = templatefile("${path.module}/api_pnpg/external_api_data_vault/v1/openapi.${var.env}.json", {
    host     = local.pnpg_hostname
    basePath = "v1"
  })

  xml_content = templatefile("${path.module}/api_pnpg/jwt_base_policy.xml.tpl", {
...
module "apim_pnpg_external_api_ms_v2" {
  ...
  content_format = "openapi+json"
  content_value = templatefile("${path.module}/api_pnpg/external_api_for_pnpg/v2/openapi.${var.env}.json", {
    host     = local.pnpg_hostname
    basePath = "v1"
  })
  ...
  api_operation_policies = [
    {
      ...
      xml_content = templatefile("${path.module}/api/jwt_auth_op_policy_user_group.xml", {
    ...
    },
    {
      ...
      xml_content = templatefile("${path.module}/api/base_ms_url_product_policy.xml", {
        MS_BACKEND_URL = "https://selc-${var.env_short}-pnpg-institution-ms-ca.${var.ca_pnpg_suffix_dns_private_name}/"
      })
    },
    {
...
module "apim_pnpg_support_service_v2" {
  ...
  content_format = "openapi+json"
  content_value = templatefile("${path.module}/api_pnpg/pnpg_support_service/v1/openapi.${var.env}.json", {
    host     = local.pnpg_hostname
    basePath = "v1"
  })
...
module "apim_pnpg_internal_api" {
  ...
  content_format = "openapi+json"
  content_value = templatefile("${path.module}/api_pnpg/internal_api_for_pnpg/v1/openapi.${var.env}.json", {
    host     = local.pnpg_hostname
    basePath = "v1"
  })
...
module "apim_pnpg_product_pn_pg" {
  ...
  policy_xml = file("${path.module}/api_product_pnpg/pnpg/policy.xml")
}
...
module "apim_product_pnpg_uat_cert" {
  ...
  policy_xml = file("${path.module}/api_product_pnpg/pnpg_uat_cert/policy.xml")
}
...
module "apim_product_pnpg_uat_coll" {
  ...
  policy_xml = file("${path.module}/api_product_pnpg/pnpg_uat_coll/policy.xml")
}
...
module "apim_product_pnpg_uat_svil" {
  ...
  policy_xml = file("${path.module}/api_product_pnpg/pnpg_uat_svil/policy.xml")
}
...
module "apim_product_pnpg_uat" {
  ...
  policy_xml = file("${path.module}/api_product_pnpg/pnpg_uat/policy.xml")
}
...
module "apim_product_pnpg_dev" {
  ...
  policy_xml = file("${path.module}/api_product_pnpg/pnpg_dev/policy.xml")
}
...
module "apim_product_pnpg_test" {
  ...
  policy_xml = file("${path.module}/api_product_pnpg/pnpg_test/policy.xml")
}
