...
locals {
  onboarding_functions = {
    ...
    app_settings = [
      { name = "APPLICATIONINSIGHTS_CONNECTION_STRING", value = "@Microsoft.KeyVault(SecretUri=https://selc-d-kv.vault.azure.net/secrets/appinsights-connection-string/)" },
      { name = "USER_REGISTRY_URL", value = "https://api.uat.pdv.pagopa.it/user-registry/v1" },
      { name = "MONGODB_CONNECTION_URI", value = "@Microsoft.KeyVault(SecretUri=https://selc-d-kv.vault.azure.net/secrets/mongodb-connection-string/)" },
      { name = "USER_REGISTRY_API_KEY", value = "@Microsoft.KeyVault(SecretUri=https://selc-d-kv.vault.azure.net/secrets/user-registry-api-key/)" },
      { name = "BLOB_STORAGE_CONN_STRING_PRODUCT", value = "@Microsoft.KeyVault(SecretUri=https://selc-d-kv.vault.azure.net/secrets/blob-storage-product-connection-string/)" },
      { name = "STORAGE_CONTAINER_CONTRACT", value = "sc-d-documents-blob" },
      { name = "STORAGE_CONTAINER_PRODUCT", value = "selc-d-product" },
      { name = "BLOB_STORAGE_CONN_STRING_CONTRACT", value = "@Microsoft.KeyVault(SecretUri=https://selc-d-kv.vault.azure.net/secrets/documents-storage-connection-string/)" },
      ...
      { name = "MAIL_SENDER_ADDRESS", value = "@Microsoft.KeyVault(SecretUri=https://selc-d-kv.vault.azure.net/secrets/smtp-usr/)" },
      { name = "MAIL_SERVER_USERNAME", value = "@Microsoft.KeyVault(SecretUri=https://selc-d-kv.vault.azure.net/secrets/smtp-usr/)" },
      { name = "MAIL_SERVER_PASSWORD", value = "@Microsoft.KeyVault(SecretUri=https://selc-d-kv.vault.azure.net/secrets/smtp-psw/)" },
      ...
      { name = "ADDRESS_EMAIL_NOTIFICATION_ADMIN", value = "@Microsoft.KeyVault(SecretUri=https://selc-d-kv.vault.azure.net/secrets/portal-admin-operator-email/)" },
      ...
      { name = "SELFCARE_ADMIN_NOTIFICATION_URL", value = "https://dev.selfcare.pagopa.it/dashboard/admin/onboarding/" },
      { name = "SELFCARE_URL", value = "https://selfcare.pagopa.it" },
      { name = "MAIL_ONBOARDING_CONFIRMATION_LINK", value = "https://dev.selfcare.pagopa.it/onboarding/confirm?jwt=" },
      { name = "MAIL_USER_CONFIRMATION_LINK", value = "https://dev.selfcare.pagopa.it/onboarding/confirm?add-user=true&jwt=" },
      { name = "MAIL_ONBOARDING_REJECTION_LINK", value = "https://dev.selfcare.pagopa.it/onboarding/cancel?jwt=" },
      { name = "MAIL_ONBOARDING_URL", value = "https://dev.selfcare.pagopa.it/onboarding/" },
      { name = "MS_USER_URL", value = "https://selc-d-user-ms-ca.whitemoss-eb7ef327.westeurope.azurecontainerapps.io" },
      { name = "MS_CORE_URL", value = "https://selc-d-ms-core-ca.whitemoss-eb7ef327.westeurope.azurecontainerapps.io" },
      { name = "JWT_BEARER_TOKEN", value = "@Microsoft.KeyVault(SecretUri=https://selc-d-kv.vault.azure.net/secrets/jwt-bearer-token-functions/)" },
      { name = "MS_PARTY_REGISTRY_URL", value = "https://selc-d-party-reg-proxy-ca.whitemoss-eb7ef327.westeurope.azurecontainerapps.io" },
      { name = "USER_MS_SEND_MAIL", value = "false" },
      { name = "EVENT_HUB_BASE_PATH", value = "https://selc-d-eventhub-ns.servicebus.windows.net" },
      { name = "STANDARD_SHARED_ACCESS_KEY_NAME", value = "selfcare-wo" },
      { name = "EVENTHUB_SC_CONTRACTS_SELFCARE_WO_KEY_LC", value = "@Microsoft.KeyVault(SecretUri=https://selc-d-kv.vault.azure.net/secrets/eventhub-sc-contracts-selfcare-wo-key-lc/)" },
      { name = "STANDARD_TOPIC_NAME", value = "SC-Contracts" },
      { name = "SAP_SHARED_ACCESS_KEY_NAME", value = "external-interceptor-wo" },
      { name = "EVENTHUB_SC_CONTRACTS_SAP_SELFCARE_WO_KEY_LC", value = "@Microsoft.KeyVault(SecretUri=https://selc-d-kv.vault.azure.net/secrets/eventhub-sc-contracts-sap-external-interceptor-wo-key-lc/)" },
      { name = "SAP_TOPIC_NAME", value = "SC-Contracts-SAP" },
      { name = "FD_SHARED_ACCESS_KEY_NAME", value = "external-interceptor-wo" },
      { name = "EVENTHUB_SC_CONTRACTS_FD_SELFCARE_WO_KEY_LC", value = "@Microsoft.KeyVault(SecretUri=https://selc-d-kv.vault.azure.net/secrets/eventhub-selfcare-fd-external-interceptor-wo-key-lc/)" },
      ...
      { name = "PROD_FD_URL", value = "https://fid00001fe.siachain.sv.sia.eu:30008" },
      { name = "FD_TOKEN_GRANT_TYPE", value = "@Microsoft.KeyVault(SecretUri=https://selc-d-kv.vault.azure.net/secrets/prod-fd-grant-type/)" },
      { name = "FD_TOKEN_CLIENT_ID", value = "@Microsoft.KeyVault(SecretUri=https://selc-d-kv.vault.azure.net/secrets/prod-fd-client-id/)" },
      { name = "FD_TOKEN_CLIENT_SECRET", value = "@Microsoft.KeyVault(SecretUri=https://selc-d-kv.vault.azure.net/secrets/prod-fd-client-secret/)" },
      { name = "EMAIL_SERVICE_AVAILABLE", value = "true" },
      { name = "JWT_TOKEN_ISSUER", value = "SPID" },
      { name = "JWT_TOKEN_PRIVATE_KEY", value = "@Microsoft.KeyVault(SecretUri=https://selc-d-kv.vault.azure.net/secrets/jwt-private-key/)" },
      { name = "JWT_TOKEN_KID", value = "@Microsoft.KeyVault(SecretUri=https://selc-d-kv.vault.azure.net/secrets/jwt-kid/)" },
      { name = "WEBHOOK_BASE_PATH", value = "https://selc-d-webhook-ms-ca.whitemoss-eb7ef327.westeurope.azurecontainerapps.io" },
      { name = "PAGOPA_SIGNATURE_SOURCE", value = "namirial" },
      { name = "NAMIRIAL_BASE_URL", value = "https://selc-d-namirial-sws-ca.whitemoss-eb7ef327.westeurope.azurecontainerapps.io" },
      { name = "NAMIRIAL_SIGN_SERVICE_IDENTITY_USER", value = "@Microsoft.KeyVault(SecretUri=https://selc-d-kv.vault.azure.net/secrets/namirial-sign-service-user/)" },
      { name = "NAMIRIAL_SIGN_SERVICE_IDENTITY_PASSWORD", value = "@Microsoft.KeyVault(SecretUri=https://selc-d-kv.vault.azure.net/secrets/namirial-sign-service-psw/)" },
      { name = "ONBOARDING_DATA_ENCRIPTION_KEY", value = "@Microsoft.KeyVault(SecretUri=https://selc-d-kv.vault.azure.net/secrets/onboarding-data-encryption-key/)" },
      { name = "ONBOARDING_DATA_ENCRIPTION_IV", value = "@Microsoft.KeyVault(SecretUri=https://selc-d-kv.vault.azure.net/secrets/onboarding-data-encryption-iv/)" }
    ]
  }
}
