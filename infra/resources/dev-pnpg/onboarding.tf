...
locals {
  onboarding_functions = {
    ...
    app_settings = [
      { name = "APPLICATIONINSIGHTS_CONNECTION_STRING", value = "@Microsoft.KeyVault(SecretUri=https://selc-d-pnpg-kv.vault.azure.net/secrets/appinsights-connection-string/)" },
      { name = "USER_REGISTRY_URL", value = "https://api.uat.pdv.pagopa.it/user-registry/v1" },
      { name = "MONGODB_CONNECTION_URI", value = "@Microsoft.KeyVault(SecretUri=https://selc-d-pnpg-kv.vault.azure.net/secrets/mongodb-connection-string/)" },
      { name = "USER_REGISTRY_API_KEY", value = "@Microsoft.KeyVault(SecretUri=https://selc-d-pnpg-kv.vault.azure.net/secrets/user-registry-api-key/)" },
      { name = "BLOB_STORAGE_CONN_STRING_PRODUCT", value = "@Microsoft.KeyVault(SecretUri=https://selc-d-pnpg-kv.vault.azure.net/secrets/blob-storage-product-connection-string/)" },
      { name = "STORAGE_CONTAINER_CONTRACT", value = "selc-d-contracts-blob" },
      { name = "STORAGE_CONTAINER_PRODUCT", value = "selc-d-product" },
      { name = "BLOB_STORAGE_CONN_STRING_CONTRACT", value = "@Microsoft.KeyVault(SecretUri=https://selc-d-pnpg-kv.vault.azure.net/secrets/contracts-storage-blob-connection-string/)" },
      ...
      { name = "MAIL_SENDER_ADDRESS", value = "@Microsoft.KeyVault(SecretUri=https://selc-d-pnpg-kv.vault.azure.net/secrets/smtp-usr/)" },
      { name = "MAIL_SERVER_USERNAME", value = "@Microsoft.KeyVault(SecretUri=https://selc-d-pnpg-kv.vault.azure.net/secrets/smtp-usr/)" },
      { name = "MAIL_SERVER_PASSWORD", value = "@Microsoft.KeyVault(SecretUri=https://selc-d-pnpg-kv.vault.azure.net/secrets/smtp-psw/)" },
      ...
      { name = "ADDRESS_EMAIL_NOTIFICATION_ADMIN", value = "@Microsoft.KeyVault(SecretUri=https://selc-d-pnpg-kv.vault.azure.net/secrets/portal-admin-operator-email/)" },
      ...
      { name = "SELFCARE_ADMIN_NOTIFICATION_URL", value = "https://imprese.dev.notifichedigitali.it/dashboard/admin/onboarding/" },
      { name = "SELFCARE_URL", value = "https://imprese.dev.notifichedigitali.it" },
      { name = "MAIL_ONBOARDING_CONFIRMATION_LINK", value = "https://imprese.dev.notifichedigitali.it/onboarding/confirm?jwt=" },
      { name = "MAIL_USER_CONFIRMATION_LINK", value = "https://imprese.dev.notifichedigitali.it/onboarding/confirm?add-user=true&jwt=" },
      { name = "MAIL_ONBOARDING_REJECTION_LINK", value = "https://imprese.dev.notifichedigitali.it/onboarding/cancel?jwt=" },
      { name = "MAIL_ONBOARDING_URL", value = "https://imprese.dev.notifichedigitali.it/onboarding/" },
      { name = "MS_USER_URL", value = "https://selc-d-pnpg-user-ms-ca.victoriousfield-e39534b8.westeurope.azurecontainerapps.io" },
      { name = "MS_CORE_URL", value = "https://selc-d-pnpg-ms-core-ca.blackhill-644148c0.westeurope.azurecontainerapps.io" },
      { name = "JWT_BEARER_TOKEN", value = "@Microsoft.KeyVault(SecretUri=https://selc-d-pnpg-kv.vault.azure.net/secrets/jwt-bearer-token-functions/)" },
      { name = "MS_PARTY_REGISTRY_URL", value = "https://selc-d-pnpg-party-reg-proxy-ca.victoriousfield-e39534b8.westeurope.azurecontainerapps.io" },
      ...
      { name = "EMAIL_SERVICE_AVAILABLE", value = "FALSE" },
      { name = "JWT_TOKEN_ISSUER", value = "SPID" },
      { name = "JWT_TOKEN_PRIVATE_KEY", value = "@Microsoft.KeyVault(SecretUri=https://selc-d-pnpg-kv.vault.azure.net/secrets/jwt-private-key/)" },
      { name = "JWT_TOKEN_KID", value = "@Microsoft.KeyVault(SecretUri=https://selc-d-pnpg-kv.vault.azure.net/secrets/jwt-kid/)" }
    ]
  }
}
