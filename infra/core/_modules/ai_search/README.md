...
| ---- | ----------- | ---- | ------- | :------: |
| <a name="input_adgroup_admin_object_id"></a> [adgroup\_admin\_object\_id](#input\_adgroup\_admin\_object\_id) | Object ID of the Azure AD admin group (e.g. selc-d-adgroup-admin) | `string` | n/a | yes |
| <a name="input_adgroup_developers_object_id"></a> [adgroup\_developers\_object\_id](#input\_adgroup\_developers\_object\_id) | Object ID of the Azure AD developers group (e.g. selc-d-adgroup-developers) | `string` | n/a | yes |
