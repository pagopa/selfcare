...
#   selfcare_status_prod_email = try(module.key_vault.secrets_selfcare_status_prod["alert-selfcare-status-prod-email"].value, "")
#   selfcare_status_prod_slack = try(module.key_vault.secrets_selfcare_status_prod["alert-selfcare-status-prod-slack"].value, "")
# }
