...
class UserUtilTest {
    ...
    void checkRoleValid() {
        ...
        Assertions.assertDoesNotThrow(() -> userUtils.checkProductRolesAndValidateMultirole("prod-pagopa", PartyRole.MANAGER, List.of("operatore")));
    }
    ...
    void checkRoleProductRoleNotFound() {
        ...
        Assertions.assertThrows(InvalidRequestException.class, () -> userUtils.checkProductRolesAndValidateMultirole("prod-pagopa", PartyRole.MANAGER, List.of("amministratore")), "RoleMappings map for product prod-pagopa not found");
    }
    ...
    void checkRoleProductRoleListNotExists() {
        ...
        Assertions.assertThrows(InvalidRequestException.class, () -> userUtils.checkProductRolesAndValidateMultirole("prod-pagopa", PartyRole.DELEGATE, List.of("operatore")), "Role DELEGATE not found");
    }
    ...
    void checkProductRoleWithoutProductRole() {
        ...
        Assertions.assertThrows(InvalidRequestException.class, () -> userUtils.checkProductRolesAndValidateMultirole("prod-io", PartyRole.MANAGER, List.of("operatore")), "ProductRole operatore not found for role MANAGER");
    }
    ...
    void checkProductRoleWithoutRole() {
        ...
        Assertions.assertThrows(InvalidRequestException.class, () -> userUtils.checkProductRolesAndValidateMultirole("prod-io", null, List.of("operatore")), "Role is mandatory to check productRole");
    }
    ...
    void checkRoleWithoutProduct() {
        ...
        Assertions.assertThrows(InvalidRequestException.class, () -> userUtils.checkProductRolesAndValidateMultirole("prod-io", PartyRole.MANAGER, List.of("admin")), "ProductRole admin not found for role MANAGER");
    }
