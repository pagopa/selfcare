...
public class TemplateMailConstant {
    ...
    public static final String REQUEST_SUBJECT = "Richiesta di adesione nell'Area Riservata";
    public static final String CONVENTION_SUBJECT = "Richiesta di convenzionamento";
    ...
    public static final String REQUEST_TEMPLATE = "user_request.ftlh";
    public static final String CONVENTION_TEMPLATE = "convention_request.ftlh";
