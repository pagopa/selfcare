Feature: Contract Template API
  ...
  Scenario: Successfully upload a contract template
    ...
    When I send a POST request to "/contract-template/AR" with form data and multi-part file
  ...
  Scenario: Successfully download html contract template
    ...
    When I send a GET request to "/contract-template/AR/{contractTemplateId}"
  ...
  Scenario: Successfully list all contract templates by productId
    ...
    And The following query params:
      | productId | prod-test |
    When I send a GET request to "/contract-template/AR"
    Then The status code is 200
