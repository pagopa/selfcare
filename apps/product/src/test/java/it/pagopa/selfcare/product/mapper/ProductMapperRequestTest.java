...
public class ProductMapperRequestTest {
    ...
    public void toProductTest() {
        // given
        ProductCreateRequest productCreateRequest = ProductCreateRequest.builder().productId("prod-test").build();
    ...
    public void toCloneObjectTest() {
        ...
        // when
        Product preProduct = Product.builder().productId("prod-base").status(ProductStatus.TESTING).build();
