...
public class ContractTemplateControllerTest {
  ...
  @InjectMock private ContractTemplateService contractTemplateService;
        ...
        ContractTemplateFile.builder()
            .data(
                Files.readAllBytes(
                    Paths.get(
                        getClass()
                            .getResource("/request/contract-template-fragment.html")
                            .toURI())))
  ...
  void download_shouldReturnPDF() throws URISyntaxException, IOException {
    final ContractTemplateFile contractTemplateFile =
        ContractTemplateFile.builder()
            .data(
                Files.readAllBytes(
                    Paths.get(getClass().getResource("/request/contract-template.pdf").toURI())))
  ...
  void list_shouldReturnOk() {
    Mockito.when(contractTemplateService.list("prod-test", "test", "1.0.0"))
        .thenReturn(
            Uni.createFrom()
                .item(
                    new ContractTemplateResponseList(
                        List.of(
                            ContractTemplateResponse.builder()
                                .contractTemplateId("123")
                                .contractTemplatePath("contract-templates/prod-test/123.html")
