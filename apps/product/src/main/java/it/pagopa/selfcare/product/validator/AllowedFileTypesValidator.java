...
@Slf4j
public class AllowedFileTypesValidator implements ConstraintValidator<AllowedFileTypes, FileUpload> {
    ...
    public boolean isValid(FileUpload fileUpload, ConstraintValidatorContext constraintValidatorContext) {
        ...
        return switch (contentType) {
            ...
            case AllowedFileTypes.PDF -> false; // TODO: Implement security checks before allowing PDF files
            default -> false;
        };
    }
