...
class ProductCdcServiceTest {
  ...
  void invokeCreationDocument_shouldUpdateStorageSuccessfully() {
    ...
    it.pagopa.selfcare.product.entity.Product entityProduct =
    ...
    it.pagopa.selfcare.product.entity.Product existingProduct =
        new it.pagopa.selfcare.product.entity.Product();
  ...
  void invokeCreationDocument_shouldReplaceExistingProduct() {
    ...
    it.pagopa.selfcare.product.entity.Product oldProduct =
        new it.pagopa.selfcare.product.entity.Product();
