...
@Readiness
@ApplicationScoped
public class InstitutionCdcTableStorageReadinessCheck extends AbstractAsyncReadinessCheck {
    ...
    @Inject
    public InstitutionCdcTableStorageReadinessCheck(
            TableClient tableClient,
            @ConfigProperty(name = "institution-cdc.table.name") String tableName,
            @ConfigProperty(name = "institution-cdc.storage-account-name") Optional<String> account) {
    ...
    protected String checkName() {
        return "table-storage-institution-cdc";
    }
