...
@Readiness
@ApplicationScoped
public class InstitutionCdcMongoReadinessCheck extends AbstractMongoReadinessCheck {
    ...
    @Inject
    public InstitutionCdcMongoReadinessCheck(
    ...
    protected String checkName() {
        return "mongodb-institution-cdc";
    }
