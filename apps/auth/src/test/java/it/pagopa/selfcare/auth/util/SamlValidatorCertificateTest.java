...
class SamlValidatorCertificateTest {
  ...
  private static class CertificateTestUtils {
    ...
    public static X509Certificate generateCertificate(Instant start, Instant end, KeyPair keyPair)
        throws Exception {
  ...
  void setUp() throws Exception {
    ...
    testCertificate =
        CertificateTestUtils.generateCertificate(
            FAKE_CERT); // "CN=test.com", startDate, endDate, keyPair
