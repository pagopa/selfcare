Feature: Oidc with daily limit open

  Scenario: Successful OIDC exchange with OTP feature flag set to "NONE" with limit open
  ...
  Scenario: Successful OIDC exchange with OTP feature flag set to "BETA" and user not in beta list with limit open
  ...
  Scenario: Successful OIDC exchange with OTP feature flag set to "BETA", user in beta list, forced OTP disabled and no previous OTP flow found with limit open
  ...
  @RemoveOtpFlow
  Scenario: Successful OIDC exchange with OTP feature flag set to "BETA", user in beta list, forced OTP and no previous OTP flow found with limit open
    Given User login with username "r.balboa" and password "test"
    And OTP feature flag is set to "BETA"
    And User in the beta user list with the following details:
      | fiscalCode  | blbrki80A41H401T                |
  ...
  @RemoveOtpFlow
  Scenario: Successful OIDC exchange with OTP feature flag set to "BETA", user in beta list, forced OTP, previous OTP flow found and new Otp flow required with limit open
  ...
  Scenario: Successful OIDC exchange with OTP feature flag set to "BETA", user in beta list, forced OTP disabled and previous completed OTP flow with sameIdp=true found with limit open
    Given User login with username "j.doe" and password "test"
    And OTP feature flag is set to "BETA"
    And User in the beta user list with the following details:
      | fiscalCode  | PRVTNT80A41H401T                |
  ...
  Scenario: Successful OIDC exchange with OTP feature flag set to "BETA", user in beta list, forced OTP disabled and previous pending OTP flow with sameIdp=false found with limit open
    Given User login with username "j.doe" and password "test"
    And OTP feature flag is set to "BETA"
    And User in the beta user list with the following details:
      | fiscalCode  | PRVTNT80A41H401T                |
  ...
  Scenario: Successful OIDC exchange with OTP feature flag set to "BETA", user in beta list, forced OTP and previous pending OTP flow found with limit open
    Given User login with username "j.doe" and password "test"
    And OTP feature flag is set to "BETA"
    And User in the beta user list with the following details:
      | fiscalCode  | PRVTNT80A41H401T                |
  ...
  Scenario: Not found token in one identity create request token with limit open
    And The following request body:
    """
    {
  ...
  Scenario: Fail extract claims from Jwt token with limit open
    And The following request body:
      """
      {
  ...
  Scenario: Fail saving user using patch, user not found in user registry with limit open
    And The following request body:
      """
      {
  ...
  Scenario: Fail getting user info email on external internal APIs with limit open
    And OTP feature flag is set to "BETA"
    And User in the beta user list with the following details:
