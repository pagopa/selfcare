...
public class ContractTemplateController {
  ...
  @Operation(
      ...
      description =
          "Upload an html file as a new contract template version to be used in product configuration",
        ...
        @APIResponse(
            ...
            content =
                @Content(
                    ...
                    schema = @Schema(implementation = ContractTemplateResponse.class))),
        @APIResponse(
            responseCode = "400",
  ...
  public Uni<Response> upload(
      ...
      @QueryParam("name")
          ...
          @Pattern(
              regexp = "^[a-zA-Z0-9 ]+$",
              message = "The field can only contain letters, numbers, and spaces")
          String name,
      @QueryParam("version")
          @NotNull
          @Pattern(
              regexp = "^\\d+\\.\\d+\\.\\d+$",
              message = "The format must be X.X.X where X is a number")
          String version,
    ...
    return contractTemplateService
        .upload(
            ContractTemplateUploadRequest.builder()
                ...
                .build())
        .onItem()
        .transform(r -> Response.status(Response.Status.CREATED).entity(r).build());
  }
      ...
      value = {
        @APIResponse(
            ...
            content =
                @Content(
                    mediaType = MediaType.APPLICATION_JSON,
                    schema = @Schema(implementation = ContractTemplateResponseList.class))),
        @APIResponse(
            responseCode = "400",
            description = "Bad Request",
            content =
