...
class IpaOpenDataServiceTest {
  @Mock IpaInstitutionOpenDataRestClient institutionRestClient;
  @Mock IpaCategoriesOpenDataRestClient categoryRestClient;
  ...
  @InjectMocks IpaUoOpenDataService ipaUoOpenDataService;

  @BeforeEach
  void setUp() {
    ReflectionTestUtils.setField(
        ipaInstitutionOpenDataService, "restClient", institutionRestClient);
