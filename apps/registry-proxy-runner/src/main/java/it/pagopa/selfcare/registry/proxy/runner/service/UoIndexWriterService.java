...
@ApplicationScoped
public class UoIndexWriterService extends AbstractIndexWriterService<IpaUo, IpaUoIndex> {
  ...
  @Inject
  public UoIndexWriterService(@RestClient AzureSearchRestClient azureSearchRestClient) {
