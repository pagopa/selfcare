...
class OpenDataLoaderTest {
  ...
  @MockBean private ANACService anacService;

  @MockBean private IvassDataConnector ivassDataConnector;
  ...
  @MockBean private IndexWriterService<UO> uoIndexWriterService;

  @MockBean private IndexWriterService<Station> pdndIndexWriterService;

  @MockBean private IndexWriterService<InsuranceCompany> ivassIndexWriterService;

  @Autowired private OpenDataLoader openDataLoader;

  @Test
  void run() {
    // given
    final List institutions = List.of();
    when(openDataConnector.getInstitutions()).thenReturn(institutions);
