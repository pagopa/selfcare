...
public class SearchServiceImplTest {
  ...
  void searchOnboardingTest() {
    ...
    final OffsetDateTime statusUpdatedFromDate = OffsetDateTime.parse("2023-01-01T00:00:00Z");
    final OffsetDateTime statusUpdatedToDate = OffsetDateTime.parse("2023-12-31T23:59:59Z");
    ...
    final String filter = "search.in(productId, 'prod-io,prod-pagopa') and search.in(institutionType, 'PA,GSP') and search.in(status, 'ACTIVE,PENDING') and createdAt ge 2023-01-01T00:00:00Z and createdAt le 2023-12-31T23:59:59Z and statusUpdatedAt ge 2023-01-01T00:00:00Z and statusUpdatedAt le 2023-12-31T23:59:59Z and isTest ne true";
    final OnboardingIndexSearch mockResponse = new OnboardingIndexSearch();
    ...
    final OnboardingIndexSearch onboardingIndexSearch = searchService.searchOnboarding(searchText, products, institutionTypes, statuses, createdFromDate, createdToDate, statusUpdatedFromDate, statusUpdatedToDate, page, pageSize, orderBy, includeTest);
  ...
  void searchOnboardingTest_withoutStatusAndOptionalFields() {
    ...
    final OnboardingIndexSearch onboardingIndexSearch = searchService.searchOnboarding(searchText, products, institutionTypes, statuses, null, null, null, null, null,null, null, true);
  ...
  void searchOnboardingTest_withoutStatusAndInstitutionTypes() {
    ...
    mockResponse.setTotalElements(100L);
    when(searchServiceConnector.searchOnboarding(searchText, filter, 15L, 0L, "description asc")).thenReturn(mockResponse);
    final OnboardingIndexSearch onboardingIndexSearch = searchService.searchOnboarding(searchText, products, institutionTypes, statuses, null, null, null, null, null, null, null, false);
    verify(searchServiceConnector, times(1)).searchOnboarding(searchText, filter, 15L, 0L, "description asc");
    assertEquals(0L, onboardingIndexSearch.getPage());
    assertEquals(15L, onboardingIndexSearch.getPageSize());
    assertEquals(100L, mockResponse.getTotalElements());
  ...
  void searchOnboardingWhenOrderIsNotValid() {
    ...
    final OnboardingIndexSearch mockResponse = new OnboardingIndexSearch();
    mockResponse.setTotalElements(100L);
    assertThrows(IllegalArgumentException.class, () -> searchService.searchOnboarding(searchText, products, institutionTypes, statuses, null, null, null, null, page, pageSize, orderBy, false));
  }
  ...
  void searchOnboardingWhenOrderIsNotValid2() {
    ...
    final OnboardingIndexSearch mockResponse = new OnboardingIndexSearch();
    mockResponse.setTotalElements(100L);
    assertThrows(IllegalArgumentException.class, () -> searchService.searchOnboarding(searchText, products, institutionTypes, statuses, null, null, null, null, page, pageSize, orderBy, true));
  }
