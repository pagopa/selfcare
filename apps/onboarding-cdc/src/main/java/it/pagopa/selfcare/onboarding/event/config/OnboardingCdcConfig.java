...
public class OnboardingCdcConfig {
    ...
    @ApplicationScoped
    public TableClient tableClient(@ConfigProperty(name = "onboarding-cdc.storage.connection-string") Optional<String> storageConnectionString,
                                   @ConfigProperty(name = "onboarding-cdc.table.name") String tableName,
                                   @ConfigProperty(name = "onboarding-cdc.storage-account-name") Optional<String> storageAccountName,
                                   @ConfigProperty(name = "onboarding-cdc.managed-identity-client-id") Optional<String> managedIdentityClientId) {
