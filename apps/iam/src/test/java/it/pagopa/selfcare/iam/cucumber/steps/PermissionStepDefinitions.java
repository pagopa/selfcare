...
public class PermissionStepDefinitions {
  ...
  public void aUserWithUIDHasTheFollowingPermissionsForProduct(String userId, String productId, DataTable dataTable) {
  ...
  public void aUserWithUIDHasPermissionsForProductAndInstitution(String userId, String productId, String institutionId) {
    this.currentUserId = userId;
  ...
  @When("I check if user {string} has permission {string} for product {string} and institution {string}")
  public void iCheckIfUserHasPermissionForProductAndInstitution(String userId, String permission, 
