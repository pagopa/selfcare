...
Feature: User
  ...
  Scenario: Successfully retrieve users for given institutionId with productRoles filter
    ...
    And The dashboard response body contains at path "find { it.id == '85a521d6-2acd-47b9-afed-2f3c65753b7b' }.product.roleInfos" the following list of objects in any order:
