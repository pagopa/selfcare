...
@Readiness
@ApplicationScoped
public class UserCdcTableStorageReadinessCheck extends AbstractAsyncReadinessCheck {
    ...
    @Inject
    public UserCdcTableStorageReadinessCheck(
            TableClient tableClient,
            @ConfigProperty(name = "user-cdc.table.name") String tableName,
            @ConfigProperty(name = "user-cdc.table.account-name") Optional<String> account) {
