...
public class ProductBlobStorageReadinessCheck extends AbstractBlobStorageReadinessCheck {
    ...
    public ProductBlobStorageReadinessCheck(
            ...
            @ConfigProperty(name = "user-cdc.blob-storage.container-product") String container,
            @ConfigProperty(name = "user-cdc.storage.account-name") Optional<String> account,
            @ConfigProperty(name = "user-cdc.blob-storage.filepath-product") String probeTarget) {
