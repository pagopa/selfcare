...
import it.pagopa.selfcare.onboarding.client.model.institutions.ManagerVerification;
...
class UserServiceImplTest {
    ...
    void validate_validUserData() {
        // given
        User user = TestUtils.mockInstance(new User());
        final it.pagopa.selfcare.onboarding.client.model.user.User userFound =
                new it.pagopa.selfcare.onboarding.client.model.user.User();
