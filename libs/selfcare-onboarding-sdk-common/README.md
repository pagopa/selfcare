# Selfcare Onboarding SDK Common
...
<dependency>
    ...
    <artifactId>selfcare-onboarding-sdk-common</artifactId>
...
```shell script
dependencies {
    implementation 'it.pagopa.selfcare:selfcare-onboarding-sdk-common:0.15.5'
}
```
