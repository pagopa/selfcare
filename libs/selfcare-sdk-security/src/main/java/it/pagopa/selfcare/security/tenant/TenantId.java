 ...
 * Values mirror the existing infrastructure naming convention ("-ar" / "-pnpg" suffixes under
 * {@code infra/resources/*}): {@code AR} identifies {@code selfcare.pagopa.it}, {@code PNPG}
 * identifies {@code imprese.notifichedigitali.it}.
 */
